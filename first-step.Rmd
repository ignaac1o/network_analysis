...
### Classical random grph models

### Generalized random graph models

We will now create a generalized random model with same specs as the bicimad network

```{r}
set.seed(10)
deg_bicimad <- degree(bicimad)
G_karate <- sample_degseq(deg_bicimad,method="vl")
G_karate
```
