...
first_highest_degree_id <- as.numeric(names(which(bicimad_degrees==max(bicimad_degrees))))
...
six_vertices_most_degree_index <- c(first_highest_degree_index, second_highest_degree_index,
                              third_highest_degree_index, forth_highest_degree_index,
                              five_highest_degree_index, six_highest_degree_index)
```
...
legend('topright', legend=unique(areas), fill=colors_areas_legend, col=colors_areas_legend)
```
...
```{r, fig.width=12, fig.height=12, fig.align='center'}
plot.igraph(bicimad, layout=layout_with_fr, main="Bicimad network with Fruchterman-Reingold layout", vertex.size=4, edge.width=0.2, edge.arrow.size=0.3, edge.arrow.width=1, vertex.label.cex=0.5)
legend('topright', legend=unique(areas), fill=colors_areas_legend, col=colors_areas_legend)
```
...
plot.igraph(bicimad, 
            ...
            main="Bicimad network with custom layout using the latitude and the longitude",
