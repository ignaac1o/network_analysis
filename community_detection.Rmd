...
We proceed to evaluate the certain measured vertex characteristics that quantifies the extent to which vertices may be partitioned according to them.
...
As we could expect due to the fact that each station is connected with others (without taking into account anything else), the network is neutral since the assortativity value is close to 0. Then the hubs connect with other hubs and with bike stations less used.
