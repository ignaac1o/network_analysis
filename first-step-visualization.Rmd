...
plot.igraph(bicimad, layout=layout_in_circle, main="Bicimad network with circular layout", vertex.size=8, vertex.label.cex=0.6)
```

### Circular layout

```{r, fig.width=12, fig.height=12}
plot.igraph(bicimad, layout=layout_as_star,main="Bicimad network with star layout", vertex.size=8, vertex.label.cex=0.6)
```

### Tree layout

```{r, fig.width=12, fig.height=12}
plot.igraph(bicimad, layout=layout_as_tree, main="Bicimad network with tree layout", vertex.size=8, vertex.label.cex=0.6)
```

### Grid layout

```{r, fig.width=15, fig.height=15}
plot.igraph(bicimad, layout=layout_on_grid, main="Bicimad network with grid layout", vertex.size=8, vertex.label.cex=0.6)
```

### Sphere layout

```{r, fig.width=15, fig.height=15}
plot.igraph(bicimad, layout=layout_on_sphere, main="Bicimad network with sphere layout", vertex.size=8, vertex.label.cex=0.6)
```
